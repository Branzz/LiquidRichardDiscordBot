...
public class CustomCommandListener extends ListenerAdapter {
	...
	public static final Map<String, Map<Long, Map<String, CustomCommand>>> guildCommands = new HashMap<>(); // <event, <guildId <name, command>>>
	public static final Map<String, CustomCommand> commandsByName = new HashMap<>(); // <event, command>
	...
	@Override public void onUserTyping(@NotNull UserTypingEvent event) { if (event.getType().isGuild()) on("userTyping", event, event.getGuild()); }

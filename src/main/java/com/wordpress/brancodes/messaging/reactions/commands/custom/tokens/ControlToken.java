...
import com.wordpress.brancodes.messaging.reactions.commands.custom.tokens.tree.TokenTreeNodeFunctional;
import com.wordpress.brancodes.messaging.reactions.commands.custom.tokens.tree.TokenTypeType;

import java.util.function.Supplier;
import java.util.stream.Stream;

import static com.wordpress.brancodes.messaging.reactions.commands.custom.tokens.tree.TokenTypeType.*;
